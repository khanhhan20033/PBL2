...
void Menu_infor(){
	...
	cout<<endl<<setw(j)<<char(186)<<setw(12)<<char(45)<<setw(15)<<"Le Huu Minh Vu"<<setw(29)<<char(45)<<setw(18)<<"Tran Ho Thuy Tien"<<setw(13)<<char(186);
	cout<<endl<<setw(j)<<char(186)<<setw(12)<<char(45)<<setw(14)<<"Le Viet Thanh"<<setw(61)<<char(186);
	cout<<endl<<setw(j)<<char(186)<<setw(87)<<char(186);
